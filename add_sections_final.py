...
marker = ' <!-- ============================================\n CONTACT SECTION\n ============================================ -->'
if marker in html:
    html = html.replace(marker, sections + marker)
    # Update navbar
    nav_old = '<li><a href="#projects">Projects</a></li>\n                  <li><a href="#contact">Contact</a></li>'
    nav_new = '<li><a href="#projects">Projects</a></li>\n                  <li><a href="#achievements">Achievements</a></li>\n                  <li><a href="#certifications">Certifications</a></li>\n                  <li><a href="#contact">Contact</a></li>'
    html = html.replace(nav_old, nav_new)
    
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print('✅ Successfully added Achievements and Certifications sections!')
else:
